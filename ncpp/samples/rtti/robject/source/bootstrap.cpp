...
public:
    NCPP_ROBJECT_USER_PRE_REFLECT_MEMBER(
        ...
        cout << "user pre reflect non-static member: " << F_member_static_info__::name() << " " << custom_params_p->message << std::endl;
    ...
    NCPP_ROBJECT_USER_POST_REFLECT_MEMBER(
        ...
        cout << "user post reflect non-static member: " << F_member_static_info__::name() << " " << custom_params_p->message << std::endl;
    ...
    NCPP_ROBJECT_USER_PRE_REFLECT_BASE(
        ...
        cout << "user pre reflect base B: " << F_base__::static_type_name() << " " << custom_params_p->message << std::endl;
    ...
    NCPP_ROBJECT_USER_POST_REFLECT_BASE(
        ...
        cout << "user post reflect base B: " << F_base__::static_type_name() << " " << custom_params_p->message << std::endl;
    ...
    NCPP_ROBJECT_USER_PRE_REFLECT_BASE(
        ...
        cout << "user pre reflect base C: " << F_base__::static_type_name() << " " << custom_params_p->message << std::endl;
    ...
    NCPP_ROBJECT_USER_POST_REFLECT_BASE(
        ...
        cout << "user post reflect base C: " << F_base__::static_type_name() << " " << custom_params_p->message << std::endl;
    ...
    NCPP_ROBJECT_USER_PRE_REFLECT_OBJECT(
        ...
        cout << "user pre reflect object C or B: " << F_robject__::static_type_name() << " " << custom_params_p->message << std::endl;
    ...
    NCPP_ROBJECT_USER_POST_REFLECT_OBJECT(
        ...
        cout << "user post reflect object C or B: " << F_robject__::static_type_name() << " " << custom_params_p->message << std::endl;
    ...
    NCPP_ROBJECT_USER_PRE_REFLECT_OBJECT(
        ...
        cout << "user pre reflect object A: " << F_robject__::static_type_name() << " " << custom_params_p->message << std::endl;
    ...
    NCPP_ROBJECT_USER_POST_REFLECT_OBJECT(
        ...
        cout << "user post reflect object A: " << F_robject__::static_type_name() << " " << custom_params_p->message << std::endl;
