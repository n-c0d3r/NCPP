...
#define NCPP_PRIVATE_VIRTUAL(Type, Name,...) NCPP_PRIVATE_KEYWORD virtual NCPP_MEMBER(Type, Name, __VA_ARGS__)
#define NCPP_PROTECTED_VIRTUAL(Type, Name,...) NCPP_PROTECTED_KEYWORD virtual NCPP_MEMBER(Type, Name, __VA_ARGS__)
#define NCPP_PUBLIC_VIRTUAL(Type, Name,...) NCPP_PUBLIC_KEYWORD virtual NCPP_MEMBER(Type, Name, __VA_ARGS__)

		////////////////////////////////////////////////////////////////////////////////////
		////////////////////////////////////////////////////////////////////////////////////
		////////////////////////////////////////////////////////////////////////////////////

#define NCPP_PRIVATE_VIRTUAL_CONST(Type, Name,...) NCPP_PRIVATE_KEYWORD virtual NCPP_MEMBER_CONST(Type, Name, __VA_ARGS__)
#define NCPP_PROTECTED_VIRTUAL_CONST(Type, Name,...) NCPP_PROTECTED_KEYWORD virtual NCPP_MEMBER_CONST(Type, Name, __VA_ARGS__)
#define NCPP_PUBLIC_VIRTUAL_CONST(Type, Name,...) NCPP_PUBLIC_KEYWORD virtual NCPP_MEMBER_CONST(Type, Name, __VA_ARGS__)
...
#ifdef NCPP_ENABLE_RTTI
#define NCPP_DEFINE_VIRTUAL(ClassName, Name, ReturnType, ...) void ClassName::reflector_container::Name() {} ReturnType ClassName::Name(__VA_ARGS__)
#else
#define NCPP_DEFINE_VIRTUAL(ClassName, Name, ReturnType, ...) ReturnType ClassName::Name(__VA_ARGS__)
#endif
...
#ifdef NCPP_ENABLE_RTTI
#define NCPP_DEFINE_TEMPLATE_VIRTUAL(ClassName, Name, ReturnType, ...) template##Template void ClassName::reflector_container::Name() {} template##Template ReturnType ClassName::Name(__VA_ARGS__)
#else
#define NCPP_DEFINE_TEMPLATE_VIRTUAL(Template, ClassName, Name, ReturnType, ...) template##Template ReturnType ClassName::Name(__VA_ARGS__)
#endif
