...
#define NCPP_ROBJECT_USER_REFLECT_MEMBER(CompileTimeRFlagType, ...) \
		...
		friend void operator << (CompileTimeRFlagType&, const ncpp::rtti::TF_user_reflect_member_flag<F_robject__, F_member__, F_member_static_info__, NCPP_RTTI_PASS_SPECIFIC_TARGS()>& flag) { }\
		template<class F_robject__, typename F_member__, class F_member_static_info__, NCPP_RTTI_SPECIFIC_TARGS() __VA_OPT__(,) __VA_ARGS__>\
...
#define NCPP_ROBJECT_USER_REFLECT_BASE(CompileTimeRFlagType, ...) \
		template<class F_robject__, class F_base__, NCPP_RTTI_SPECIFIC_TARGS() __VA_OPT__(,) __VA_ARGS__>\
		friend void operator << (CompileTimeRFlagType&, const ncpp::rtti::TF_user_reflect_base_flag<F_robject__, F_base__, NCPP_RTTI_PASS_SPECIFIC_TARGS()>& flag) { }\
		template<class F_robject__, class F_base__, NCPP_RTTI_SPECIFIC_TARGS() __VA_OPT__(,) __VA_ARGS__>\
...
#define NCPP_ROBJECT_USER_REFLECT_OBJECT(CompileTimeRFlagType, ...) \
		template<class F_robject__, NCPP_RTTI_SPECIFIC_TARGS() __VA_OPT__(,) __VA_ARGS__>\
		friend void operator << (CompileTimeRFlagType&, const ncpp::rtti::TF_user_reflect_object_flag<F_robject__, NCPP_RTTI_PASS_SPECIFIC_TARGS()>& flag) { }\
		template<class F_robject__, NCPP_RTTI_SPECIFIC_TARGS() __VA_OPT__(,) __VA_ARGS__>\
		static NCPP_FORCE_INLINE void T_user_reflect_object(\
			F_rcontainer__* rcontainer_p, \
			F_robject_type_info__* robject_type_info_p,\
			void* custom_data_p = 0\
		)

#define NCPP_ROBJECT_CALL_USER_REFLECT_OBJECT() F_rtti_traits::template T_safe_user_reflect_object<\
			F_reflect_flag__,\
			F_this\
		>(\
			rcontainer_p,\
...
#define NCPP_ROBJECT_BODY_BASE_STATIC_PRIVATE(Overrider, MemberType, MemberName,...) NCPP_PRIVATE_KEYWORD NCPP_EXPAND(NCPP_ROBJECT_BODY_STATIC_MEMBER(Overrider, MemberType, MemberName __VA_OPT__(,) __VA_ARGS__))
#define NCPP_ROBJECT_BODY_BASE_STATIC_PROTECTED(Overrider, MemberType, MemberName,...) NCPP_PROTECTED_KEYWORD NCPP_EXPAND(NCPP_ROBJECT_BODY_STATIC_MEMBER(Overrider, MemberType, MemberName __VA_OPT__(,) __VA_ARGS__))
#define NCPP_ROBJECT_BODY_BASE_STATIC_PUBLIC(Overrider, MemberType, MemberName,...) NCPP_PUBLIC_KEYWORD NCPP_EXPAND(NCPP_ROBJECT_BODY_STATIC_MEMBER(Overrider, MemberType, MemberName __VA_OPT__(,) __VA_ARGS__))
...
#define NCPP_ROBJECT_REFLECT_BASE_STATIC_PRIVATE(Overrider, MemberType, MemberName,...) NCPP_EXPAND(NCPP_ROBJECT_REFLECT_STATIC_MEMBER(Overrider, MemberType, MemberName __VA_OPT__(,) __VA_ARGS__))
#define NCPP_ROBJECT_REFLECT_BASE_STATIC_PROTECTED(Overrider, MemberType, MemberName,...) NCPP_EXPAND(NCPP_ROBJECT_REFLECT_STATIC_MEMBER(Overrider, MemberType, MemberName __VA_OPT__(,) __VA_ARGS__))
#define NCPP_ROBJECT_REFLECT_BASE_STATIC_PUBLIC(Overrider, MemberType, MemberName,...) NCPP_EXPAND(NCPP_ROBJECT_REFLECT_STATIC_MEMBER(Overrider, MemberType, MemberName __VA_OPT__(,) __VA_ARGS__))
...
#define NCPP_ROBJECT(RTTIOptions, ObjectTypeName,...)\
			...
			NCPP_PUBLIC_KEYWORD\
				...
				static F_robject_type_info* T_static_reflect(\
					...
					\
					NCPP_ROBJECT_CALL_USER_REFLECT_OBJECT();\
					\
