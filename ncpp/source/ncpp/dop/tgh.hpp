...
#define NCPP_NATIVE_ALLOCATOR_SYS_LIFETIME ncpp::dop::tgh::instance(), ncpp::dop::job_system::instance().tgh_sys_lifetime_cid()
        ...
        class tgh final :
            public tagged_heap_t<>,
            public utilities::singleton_t<tgh>
        {
...
#pragma region Constructors, Destructor and Operators
        public:
            ...
            inline tgh(
                const tagged_heap_t::category_id_allocator_type& category_id_allocator,
                const tagged_heap_t::category_cell_allocator_type& category_cell_allocator,
                sz capacity = NCPP_DEFAULT_TAGGED_HEAP_CAPACITY
            ) :
                tagged_heap_t(
                    category_id_allocator,
                    category_cell_allocator
                )
            {
            ...
            inline tgh(const tgh&) = delete;
            inline tgh& operator = (const tgh&) = delete;
            inline tgh(tgh&&) = delete;
            inline tgh& operator = (tgh&&) = delete;
#pragma endregion
        ...
        tgh_allocator_t<data_type__>& tgh_global_allocator_t(tagged_heap_t<>::category_id_type tgh_cid) {
            ...
            if (result.is_null()) {
                ...
                if (category == tgh_allocator_category::SYS_LIFETIME) {
                    ...
                    tgh_allocator_t<data_type__> new_instance(tgh::instance(), tgh_cid);
                    result = new_instance;
