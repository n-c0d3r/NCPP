...
namespace ncpp {
    ...
    namespace utilities {
        ...
        concept T_is_ostreamable_v = requires(F_stream__& fs, const std::remove_reference_t<F__>& f) {
            { fs << f };
        };
         ...
         */
        template<typename F_stream__, typename F__>
        concept T_is_istreamable_v = requires(F_stream__& fs, std::remove_reference_t<F__>& f) {
            { fs >> f };
        };
