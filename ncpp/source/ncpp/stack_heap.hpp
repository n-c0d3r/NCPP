...
#pragma region Allocators
	template <class value_type__, class stack_heap_type__ = stack_heap_t<>>
	class NCPP_DEFAULT_ALIGNAS stack_allocator_t :
...
#pragma region Typedefs
	public:
		...
		using stack_heap_type = stack_heap_type__;
#pragma endregion
...
#pragma region Properties
	private:
		utilities::lref_t<stack_heap_type> stack_heap_ref_;

		utilities::lref_t<stack_group> stack_group_ref_;
#pragma endregion
...
#pragma region Getters
	public:
		inline stack_heap_type& stack_heap() { return *stack_heap_ref_; }
		inline const stack_heap_type& stack_heap() const { return *stack_heap_ref_; }

		inline stack_group& group() { return *stack_group_ref_; }
		inline const stack_group& group() const { return *stack_group_ref_; }

		inline b8 is_null() const { return stack_heap_ref_.is_null(); }
#pragma endregion
...
#pragma region Constructors, Destructor and Operators
	public:
		...
		inline stack_allocator_t(stack_heap_type& stack_heap, stack_group& group) :
			stack_heap_ref_(stack_heap),
			stack_group_ref_(group)
		{
